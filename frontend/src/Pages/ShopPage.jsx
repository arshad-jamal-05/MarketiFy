    ...
    let data = ProductStateData.filter(
      (x) =>
        ...
        (filter.maincategory.length === 0 ||
          filter?.maincategory?.includes(x.maincategory?.name)) &&
        (filter.subcategory.length === 0 ||
          filter?.subcategory?.includes(x.subcategory?.name)) &&
        (filter.brand.length === 0 || filter?.brand?.includes(x.brand?.name)) &&
  ...
  function postSearchData(e) {
    ...
    let data = ProductStateData.filter(
      (x) =>
        ...
        x.maincategory?.name.toLowerCase().includes(search.toLowerCase()) ||
        x.subcategory?.name.toLowerCase().includes(search.toLowerCase()) ||
        x.brand?.name.toLowerCase().includes(search.toLowerCase()) ||
